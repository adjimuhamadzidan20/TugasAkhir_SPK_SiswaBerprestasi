...
<nav aria-label="...">
  <ul class="pagination pagination-md">
    <li class="page-item" aria-current="page">
      <a class="page-link rounded-0" href="index.php?page=hasil_perhitungan&hasil=normalisasi">Normalisasi</a>
    </li>
    <li class="page-item"><a class="page-link rounded-0" href="index.php?page=hasil_perhitungan&hasil=preferensi">Preferensi</a></li>
